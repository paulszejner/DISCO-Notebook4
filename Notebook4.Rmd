...
```
So, we will run the model on all of these options between relative humidity and source water. Later on we will add some more conditions such as  different stomatal conductances ```gs``` and  different  percentage of  isotope exchange during cellulose synthesis ```F_0```.


## PART 2: Modeling the Oxygen Isotopes in the tree ring cellulose

The following code will guide you step by step through the several isotopic fractionation processes inside the leaf and during cellulose synthesis. On this occasion, we will run the model using an extensive range of variability on the four critical factors in the model.
...
Describe this relationship between the Relative humidity and the ambient vapor pressure (kPa):
-  
-  
-  
...
Describe this relationship between the relative humidity and leaf transpiration (mol m-2 s-1) under three different stomatal conductances: 
-  
-  
-  
