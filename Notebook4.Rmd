...
You will need to download or clone the R project from https://github.com/paulszejner/Notebook4.git
...
d18O_cellulose_fo0.55_gs0.01 <- matrix (d18O_cellulose[["fo=0.55"]][["gs=0.01"]], nrow = 17, ncol = 16, byrow = F, dimnames = list(as.character(relH),as.character(water)))
d18O_cellulose_fo0.55_gs0.25 <- matrix (d18O_cellulose[["fo=0.55"]][["gs=0.25"]], nrow = 17, ncol = 16, byrow = F)
d18O_cellulose_fo0.55_gs0.5 <- matrix (d18O_cellulose[["fo=0.55"]][["gs=0.5"]], nrow = 17, ncol = 16, byrow = F)

d18O_cellulose_fo0.33_gs0.01 <- matrix (d18O_cellulose[["fo=0.33"]][["gs=0.01"]], nrow = 17, ncol = 16, byrow = F)
d18O_cellulose_fo0.33_gs0.25 <- matrix (d18O_cellulose[["fo=0.33"]][["gs=0.25"]], nrow = 17, ncol = 16, byrow = F)
d18O_cellulose_fo0.33_gs0.5 <- matrix (d18O_cellulose[["fo=0.33"]][["gs=0.5"]], nrow = 17, ncol = 16, byrow = F)

d18O_cellulose_fo0.42_gs0.01 <-matrix ( d18O_cellulose[["fo=0.42"]][["gs=0.01"]], nrow = 17, ncol = 16, byrow = F)
d18O_cellulose_fo0.42_gs0.25 <- matrix (d18O_cellulose[["fo=0.42"]][["gs=0.25"]], nrow = 17, ncol = 16, byrow = F)
d18O_cellulose_fo0.42_gs0.5 <- matrix (d18O_cellulose[["fo=0.42"]][["gs=0.5"]], nrow = 17, ncol = 16, byrow = F)
...
image(x = water, y = relH, z = t(d18O_cellulose_fo0.33_gs0.01),col = COLIS(10))
image(x = water, y = relH, z = t(d18O_cellulose_fo0.33_gs0.25),col = COLIS(10))
image(x = water, y = relH, z = t(d18O_cellulose_fo0.33_gs0.5),col = COLIS(10))
image(x = water, y = relH, z = t(d18O_cellulose_fo0.42_gs0.01),col = COLIS(10))
image(x = water, y = relH, z = t(d18O_cellulose_fo0.42_gs0.25),col = COLIS(10))
image(x = water, y = relH, z = t(d18O_cellulose_fo0.42_gs0.5),col = COLIS(10))
image(x = water, y = relH, z = t(d18O_cellulose_fo0.55_gs0.01),col = COLIS(10))
image(x = water, y = relH, z = t(d18O_cellulose_fo0.55_gs0.25),col = COLIS(10))
image(x = water, y = relH, z = t(d18O_cellulose_fo0.55_gs0.5),col = COLIS(10))
